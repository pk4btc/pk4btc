        ...
        <div class="container-main-content">
            ...
            <div class="container-main-form"> 
                ...
                <?php if (isset($_GET['error_message'])){ 
                    ?>  <p class="text-center alert-danger" id="err_message"><?php echo $_GET['error_message'];?>  </p>
                <?php } ?>
                ...
                <div class="container-main-form-content box">
                    ...
                    <form class="login-form" id="login-form" action="process_signup.php" method="POST">
                        ...
                        <div class="form-group">
                            <div class="login-input">
                                <input type="password" id="password_confirm" name="confirm-password" placeholder="confirm password" required>
                            </div>
                        </div>
                        <div class="btn-group"> 
                            <button class="login-btn" id="login-btn" name="signup_btn"
